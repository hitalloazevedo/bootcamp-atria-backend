...
var LoginUserController = /** @class */ (function () {
    function LoginUserController(loginUserUseCase) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.loginUserUseCase.execute(data)];
                    case 2:
                        token = _a.sent();
                        return [2 /*return*/, response.status(200).json(token)];
                    case 3:
                        error_1 = _a.sent();
                        return [2 /*return*/, response.status(401).json({ message: error_1.message })];
